-- ==============================================================================
-- KIXORA SEED: 01_CATALOG (PRODUCTION-SAFE)
-- Description: Authentic sneaker brands, categories, products, multi-angle images,
--              size matrices, inventory, active promo codes, and official drops.
-- Note: Contains ZERO fake customer accounts and ZERO mock orders.
-- ==============================================================================
...
BEGIN
  FOR v_prod IN SELECT id FROM public.products LOOP
    FOREACH v_size IN ARRAY v_sizes LOOP
      ...
      -- Realistic stock levels (3-8 for popular sizes, 0 for rare sold-out edge)
